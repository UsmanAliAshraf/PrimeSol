...
export default function SectionTitle({tag, text1, text2, text3, title, description }) {
    return (
        <>
            <p className="text-center font-medium text-sky-700 dark:text-sky-300 mt-28 px-10 py-2 rounded-full bg-slate-50 dark:bg-slate-900/70 border border-slate-300 dark:border-sky-500/30 w-max mx-auto">{text1} {tag}</p>
